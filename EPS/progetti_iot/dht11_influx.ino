...
#define INFLUXDB_TOKEN  "qt5kHYb2Wwg19lbGEOe3BmVJhlMf6ZxfDu_Z7Lrhiiiv9FTEGKiD_pJzkDa_qSlUPLPm0zI-1yE6THb4kg-0kA==A"
...
void setup() {
  ...
  sensors.addTag("host", "ESP_LATTANZI");
  sensors.addTag("location", "Urbino");
  sensors.addTag("room", "Lab Von Neumann");
